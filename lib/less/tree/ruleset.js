...
tree.Ruleset.prototype = {
    eval: function (env) {
        var selectors = this.selectors && this.selectors.slice(0) || null;
        ...
        // Evaluate selectors arguments.
        if (ruleset.selectors) {
            for (var i = 0; i < ruleset.selectors.length; i++) {
                Array.prototype.splice
                    .apply(ruleset.selectors, [i, 1].concat(ruleset.selectors[i].eval(env)));
            }
        }
