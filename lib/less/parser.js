    ...
    return parser = {
        ...
        parsers: {
            ...
            element: function () {
                ...
                if (e) { 
                    // find arguments selectors if any
                    var args = null;    
                    if ( /^:(?:nth\-child|first\-child|nth\-last\-child|nth\-of\-type|nth\-last\-of\-type)$/.exec(e) ) {
                            $('(') && (args = (  $(this.entities.structural) || $(this.entities.arguments))) && $(')');
                    }
                    return new(tree.Element)(c, e, args) 
                }
